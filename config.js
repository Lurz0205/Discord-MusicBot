module.exports = {
	...
	adminId: "720258152104198236", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://discord.gg/SGNYbb93KK", //- Support Server Link
	...
	website: "https://htbmusic-kt4m.onrender.com", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "Main Node", //- Used for indentifier in stats commands.
			host: "pnode1.danbot.host", //- The host name or IP of the lavalink server.
			port: 2635, // The port that lavalink is listening to. This must be a number!
	...
	embedColor: "#FFFFFF", //- Color of the embeds, hex supported
	presence: {
		...
		activities: [
			{
				name: "BEST QUALITY MUSIC", //- Status Text
